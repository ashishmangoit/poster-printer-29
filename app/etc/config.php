...
return [
    'modules' => [
        ...
        'Mageplaza_Smtp' => 0,
        'Magesales_QBMSPayment' => 1,
        'Mangoit_AutoRefreshCache' => 1,
        'Mangoit_Banner' => 1,
        'Mangoit_CartProduct' => 1,
        'Mangoit_CustomOptions' => 1,
        'Mangoit_CustomQuote' => 1,
        'Mangoit_FileUploadOption' => 1,
        'Mangoit_Minicart' => 1,
        'Mangoit_MultiplyOptions' => 1,
        'Mangoit_Pricecalculator' => 1,
        'Meetanshi_DeferJS' => 1,
        'PayPal_Braintree' => 1,
