 ...
 */
namespace Mangoit\FileUploadOption\Controller\Download;
...
class DownloadCustomOption extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
      ...
      //  print_r($productOption->getType());die();
        ...
        try {
            ...
            if (($this->getRequest()->getParam('key') != $info['secret_key']) && $custom == 'no') {
