 ...
 */
namespace Mangoit\MultiplyOptions\Block\Product\View;
...
class Options extends \Magento\Framework\View\Element\Template
{
     ...
     * @return array
     */
    protected function _getPriceConfiguration($option,$optionTitle)
    {   

        $optionPrice = $this->pricingHelper->currency($option->getPrice(true), false, false);        
            //echo 'helper'.$this->_helper->someMethod();
        $data = [
            'prices' => [
                'oldPrice' => [
        ...
        foreach ($this->getOptions() as $option) {
            ...
            if ($option->getGroupByType() == \Magento\Catalog\Model\Product\Option::OPTION_GROUP_SELECT) {
                ...
                foreach ($option->getValues() as $valueId => $value) {
                    $tmpPriceValues[$valueId] = $this->_getPriceConfiguration($value,$option->getTitle());
                }
                $priceValue = $tmpPriceValues;
            } else {
                $priceValue = $this->_getPriceConfiguration($option,$option->getTitle());
            }
